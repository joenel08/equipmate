  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <div class="container-fluid">
          <div class="row mb-5 mt-2">
            <div class="col">
              ...
              <p><span class="">Equipmate</span>
                <?php
                $page = isset($_GET['page']) ? $_GET['page'] : 'home';

           ?>
                  <i class="fas fa-angle-right mr-2 ml-2"></i> <span class=" border-bottom">
                    <?php echo $title; ?></span>
      ...
      <div class="modal fade" id="uni_modal" role='dialog'>
        <div class="modal-dialog modal-md" role="document">
          <div class="modal-content">
            <div class="modal-header bg-lightblue text-uppercase">
              <h5 class="modal-title"></h5>
            </div>
            <div class="modal-body">
            </div>
            <div class="modal-footer">
              <button type="button" class="btn btn-flat btn-lightblue text-white" id='submit'
