...
$hashed_cat_id = $_GET['material_id'];
...
$qry = $conn->query("SELECT * FROM materials_list WHERE SHA2(material_id, 256) = '$escaped_hashed_cat_id'")->fetch_array();
